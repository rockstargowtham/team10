...
<div class="card">
   <div class="card-body">
    <div><h4 class="card-title">Add Members</h4><div align="right"><a href="index.php" class="btn btn-primary">Home</a> <a href="view_members.php" class="btn btn-primary">View </a></div></div><hr>
  <form method="POST" action="add_members.php">
  <!-- Email input -->
  <div class="form-outline mb-4">
    <input type="text" name="memberid" class="form-control" />
    <label class="form-label" for="form2Example1">Member ID</label>
  </div>
  ...
  <!-- Submit button -->
 <div align="right"> <button type="submit" class="btn btn-primary btn-block">Add Members</button></div>
...
if (isset($_POST['memberid'],$_POST['username'],$_POST['password'],$_POST['custid']))
{

$sql = "INSERT INTO member (member_id,member_usrname,member_pwd,mem_customer_id)
VALUES ('".$_POST['memberid']."','".$_POST['username']."','".$_POST['password']."','".$_POST['custid']."')";
