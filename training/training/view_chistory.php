...
<div class="container" style="background-color:#FFF;margin-top:20px;">
   <div class="card" style="width:100%;background-color:#fff;">
      <div class="card-body">
     <div><h4 class="card-title">Course History</h4><div align="right"><a href="index.php" class="btn btn-primary">Home</a> <a href="add_chistory.php" class="btn btn-primary">Add </a></div></div><hr>
<?php
...
$sql="SELECT *,course.course_name FROM  course_history  JOIN  course ON course_history.ch_course_id=course.course_id";
